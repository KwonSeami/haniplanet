...
class StoryApi extends Api {
  ...
  public appendQuestion(storyPk, value) {
    return this.getAxios().post(`/${this.model}/${storyPk}/question/`, value);
  }
  
  public deleteQuestion(storyPk, questionId) {
    return this.getAxios().delete(`/${this.model}/${storyPk}/question/${questionId}/`);
  }
  
  public patchQuestion(storyPk, questionId, value) {
    return this.getAxios().patch(`/${this.model}/${storyPk}/question/${questionId}/`, value);
  }
