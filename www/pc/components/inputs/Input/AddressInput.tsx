...
const isValid = (address) => {
  const initialAddress = {jibunAddress: '', roadAddress: '', zonecode: '', addressDetail: ''};

  if (typeof address !== 'object') { return initialAddress; }
  ...
  for (const item of Object.values(address)) {
    if (typeof item !== 'string') { return initialAddress; }
  }
