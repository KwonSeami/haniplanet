...
import {$GRAY, $FONT_COLOR, $TEXT_GRAY, $POINT_BLUE, $BORDER_COLOR} from '../../../styles/variables.types';
...
const MoaGathering: React.FC<Props> = React.memo(({
  name, slug, created_at, story_count, member_count, body, avatar, bandType, onclassStatus
}) => {
          ...
          <MoaGatheringDiv>
            ...
            <ul className="gather-info">
              ...
              <li>
                ...
                &nbsp;<span>{numberWithCommas(member_count)}</span>
              </li>
            </ul>
