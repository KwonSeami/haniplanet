...
import {$BORDER_COLOR, $TEXT_GRAY, $FONT_COLOR, $GRAY} from '../../../styles/variables.types';
...
import StyledBasicTitle from '../layout/title/basicEditor/style/StyledBasicTitle';
    ...
    <StyledEditorTitle>
      ...
      <CommunityTitle>
        <Avatar
          ...
          {...me}
        />
        <span className="avatar-type">{ONCLASS_MEMBER[band_member_grade]}</span>
        {(!isNotice && !isOwner) && (
          <>
            <ul>
