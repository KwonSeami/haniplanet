...
import {$POINT_BLUE, $BORDER_COLOR, $TEXT_GRAY, $FONT_COLOR} from '../../../styles/variables.types';
...
const ProfileSkillForm: React.FC<Props> = React.memo(({
  ...
  const fetchedSkill = useSelector(({skill}: RootState) => skill, shallowEqual);
  ...
  }, [description, level, _skill, fetchedSkill]);
  ...
  return (
    <SkillFormUl className={className}>
