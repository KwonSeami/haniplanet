...
import {FB_TRACKING_ID, SITE_TITLE} from '../src/constants/env';
import {HTML_META_VIEWPORT} from '../src/constants/html';
  ...
  public render() {
    ...
    return (
      ...
      <Head>
        ...
        <link rel="icon" sizes="512x512" href="/static/images/logo/hani-app-512.png"/>
        <link rel="apple-touch-icon" sizes="512x512" href="/static/images/logo/hani-app-512.png"/>
        <link rel="icon" sizes="192x192" href="/static/images/logo/hani-app-512.png"/>
        <link rel="icon" sizes="128x128" href="/static/images/logo/hani-app-512.png"/>
        <link rel="apple-touch-icon" sizes="128x128" href="/static/images/logo/hani-app-512.png"/>
        <link rel="apple-touch-icon-precomposed" sizes="128x128" href="/static/images/logo/hani-app-512.png"/>
        ...
        <meta name="viewport" content={HTML_META_VIEWPORT.join(', ')} />
