...
import StyledButtonGroup from './style/StyledButtonGroup';
...
import {LinkSpan, P, StyledTextButton, StyledFileInput, Div} from './style/styleCompPC';
    ...
    <div>
      ...
      <ProfileListUl>
        ...
        >
          ...
          <span className="info">※ 30일마다, 변경 가능합니다.</span>
          <span className="info">※ 변경 시, 기존 닉네임으로 작성한 글 모두 변경 처리됩니다.</span>
        </ResponsiveLi>
        <ResponsiveLi
          title="기존 비밀번호"
        >
