  ...
  <dl>
    ...
    <dd>
      ...
      <ul>
        ...
        <li>
          <h3>나. 세미나, 모임/모집 개설자(개인)</h3>
          <p>- 필수항목 : 신분증 사본, 결제 정산용 통장사본</p>
        </li>
        <li>
          <h3>다. 개설자, 모임/모집 개설자(법인)</h3>
          <p>
      ...
      <p>
        ...
        <br />
        4. 회원님의 기본적 인권 침해의 우려가 있는 민감정보 (범죄경력, 유전정보 등)를 수집하지
        않습니다.
        <br />
        5. 회원님이 제공하신 모든 정보는 상기 목적에 필요한 용도 이외로는 사용되지 않으며,
        수집정보의 범위나 사용목적, 용도가 변경될 시에는 반드시 회원님들께 사전동의를 구할
        것입니다.
      </p>
    </dd>
    ...
    <dd>
      ① 이 개인정보 처리방침은 2018. 7. 5부터 적용됩니다.
      <br />
    </dd>
  </dl>
));

export default Policy180705;
