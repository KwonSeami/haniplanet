...
import {IS_PROD_SERVER, STAGE_URL, staticUrl, FROALA_PROD_KEY} from '../../../src/constants/env';
...
const EDITOR_CONFIG = {
  language: 'ko',
  height: 500,
  key: IS_PROD_SERVER && FROALA_PROD_KEY,
  ...
  toolbarButtons: [
    'fontSize', 'bold', 'italic', 'underline', 'strikeThrough', 'textColor', 'alignLeft', 'alignCenter', 'alignRight', '|',
    'quote', 'insertHR', 'insertLink', 'insertImage', 'insertVideo', 'insertFile', 'selectAll', 'dict',
  ],
  imageEditButtons: [
  ...
  const editorConfig = React.useMemo(() => ({
    ...
    events: {
      'image.uploaded': (response) => {
        ...
        editor.image.insert(image, false, uid, editor.image.get(), response);
