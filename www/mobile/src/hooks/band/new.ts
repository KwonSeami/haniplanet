...
const moaCreateForm = () => {
  ...
  const debounceCheckCommunity = React.useCallback(debounce(checkCommunity, 300), [checkCommunity]);
  const debounceChangeSlugifyStr = React.useCallback(debounce(changeSlugifyStr, 300), [changeSlugifyStr]);
